...
class ReportDefinitionServiceTestV201109(unittest.TestCase):

  """Unittest suite for ReportDefinitionService using v201109."""
...
def makeTestSuiteV201109():
  ...
  suite.addTests(unittest.makeSuite(ReportDefinitionServiceTestV201109))
  return suite
