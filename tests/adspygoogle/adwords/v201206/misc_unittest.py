...
from examples.adspygoogle.adwords.v201206.misc import get_all_images_and_videos
from examples.adspygoogle.adwords.v201206.misc import upload_image
...
class Misc(unittest.TestCase):
  ...
  def testUploadImage(self):
    ...
    upload_image.main(client, os.path.abspath(os.path.join(
        os.path.dirname(__file__), '..', 'data', 'image.jpg')))
